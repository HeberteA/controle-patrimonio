...
def pagina_itens_cadastrados(is_admin, dados_patrimonio, dados_locacoes, lista_status):
    ...
    with tab_vis_patrimonio:
        if dados_patrimonio.empty:
            ...
            st.markdown(f"""
            <div style="background-color: transparent !important; background-image: linear-gradient(160deg, #1e1e1f 0%, #0a0a0c 100%) !important; border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 10px; margin-botton:20px;">
